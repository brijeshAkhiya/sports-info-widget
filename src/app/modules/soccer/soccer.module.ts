...
@NgModule({
  declarations: [SoccerComponent, HomeComponent, FixturesComponent, TournamentListComponent, TournamentComponent, TournamentHomeComponent, TournamentFixturesComponent, TournamentMatchComponent],
  imports: [
    CommonModule,
    NgbModule,
    SoccerRoutingModule,
